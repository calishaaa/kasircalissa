			...
			<tbody>
				...
				while($d = mysqli_fetch_array($data)){
					...
					<tr>
						...
						<td><img src="../assets/<?php echo $d['gambar']; ?>" alt="Gambar Produk" width="100"></td>
						<!-- <td>
					...
					<div class="modal fade" id="edit-data<?php echo $d['ProdukID']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form action="proses_update_barang.php" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="tambah-data" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="proses_simpan_barang.php" method="post" enctype="multipart/form-data">
                <div class="modal-body">               
                    <div class="form-group">
                        <label>Nama Produk</label>
