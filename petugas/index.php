...
<div class="container mt-4">
    <div class="card">
        <div class="card-body">
            ...
            <p class="card-text">Selamat datang di halaman Petugas. Silakan akses beberapa fitur yang tersedia.</p>
        </div>
    </div>
</div>

<!-- Tambahkan elemen HR (garis horizontal) untuk memberikan jarak -->
<hr class="my-4">
